...
function getprojectrecord(){
 ...
 return $fData;
    ...
    function get_staff_info($project_id="",$received_company_name="",$rowno="",$rowperpage="",$workstatus=""){
        ...
        $this->db->join('bdcrm_web_disposition bwd','bwd.id=buf.web_disposition','left');
        $this->db->join('bdcrm_company_disposition bcd','bcd.id=buf.company_disposition','left');
